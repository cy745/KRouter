...
fun buildParamStateClass(): TypeSpec {
    fun createCompanionObject(): TypeSpec =
        TypeSpec
            .companionObjectBuilder()
            .addProperty(
                PropertySpec
                    .builder("CHECK_PROVIDED_FLAG", Int::class)
                    .initializer("1")
                    .build(),
            ).addProperty(
                PropertySpec
                    .builder("CHECK_IS_NOT_NULL_FLAG", Int::class)
                    .initializer("CHECK_PROVIDED_FLAG shl 1")
                    .build(),
            ).addProperty(
                PropertySpec
                    .builder("CHECK_TYPE_FLAG", Int::class)
                    .initializer("CHECK_IS_NOT_NULL_FLAG shl 1")
                    .build(),
            ).addProperty(
                PropertySpec
                    .builder("DEFAULT_CHECK_ACTION_FLAG", Int::class)
                    .initializer("CHECK_TYPE_FLAG or CHECK_PROVIDED_FLAG")
                    .build(),
            ).build()

    fun createCheckSelfFunction(): FunSpec =
        FunSpec
            .builder("checkSelf")
            .addModifiers(KModifier.OPEN)
            .addParameter(
                ParameterSpec
                    .builder("checkFlag", Int::class)
                    .defaultValue("DEFAULT_CHECK_ACTION_FLAG")
                    .build(),
            ).build()

    fun createProvidedClass(): TypeSpec =
        TypeSpec
            .classBuilder("Provided")
            ...
            .primaryConstructor(
                ...
                PropertySpec
                    .builder("value", TypeVariableName("T"))
                    .initializer("value")
                    .build(),
            ).build()

    fun createNotProvidedClass(): TypeSpec =
        TypeSpec
            .classBuilder("NotProvided")
            .addModifiers(KModifier.DATA)
            .superclass(ClassName("", "ParamState"))
            .primaryConstructor(
                FunSpec
    ...
    fun createProvidedButNullClass(): TypeSpec =
        TypeSpec
            .classBuilder("ProvidedButNull")
            .addModifiers(KModifier.DATA)
            .superclass(ClassName("", "ParamState"))
            .primaryConstructor(
                FunSpec
    ...
    fun createProvidedButWrongTypeClass(): TypeSpec =
        TypeSpec
            .classBuilder("ProvidedButWrongType")
            .addModifiers(KModifier.DATA)
            .superclass(ClassName("", "ParamState"))
            .primaryConstructor(
                FunSpec
